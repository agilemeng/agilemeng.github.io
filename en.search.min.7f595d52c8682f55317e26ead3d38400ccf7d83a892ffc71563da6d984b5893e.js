...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.18adad9d9081656dc3f4b9cefb2a621601d555739cdf4a7a9bc26d9ebfd6ca6c.js',function(){input.required=false;search();});}
