...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.47be4b3a8e78f9cae0d55a2add62ae97fb6a360d15fd084fd68a72735a615257.js',function(){input.required=false;search();});}
